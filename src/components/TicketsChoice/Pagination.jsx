    ...
    <div className="pagination">
      ...
      {pageNums.map((pageNum) => (
        <button
          ...
          className={`pagination__button ${currentPage === pageNum ? 'active' : ''}`}
        >
          {pageNum}
        </button>
      ))}
